...
import 'package:furniture_shop/Screen/16.%20ProfileRoutes/following_store/followers.dart';
import 'package:furniture_shop/Screen/16.%20ProfileRoutes/my_store_address/my_store_address.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  bool isLoading = true;
  _getCurrentSupplier() async {
    _supplier = await context.read<SupplierProvider>().getCurrentSupplier();
    setState(() {
      isLoading = false;
    });
  }
              ...
              body: isLoading
                  ...
                  : () {
                      List tabRoute = [
                        const MyOrderScreen(),
                        MyStoreAddress(
                          currentCustomer: _supplier,
                        ),
                        Follower(currentSupplier: _supplier),
                        null,
                        null
                      ];
                      List<String> tabName = [
                        context.localize('my_order_option'),
                        context.localize('store_address_option'),
                        context.localize('label_follower'),
